...
public class StreamAssignment {
    ...
    public void task3(){
        ...
        amount = people.stream()
                        .filter(p -> p.getLastName().equalsIgnoreCase("Andersson"))
                        .count();
    ...
    public void task7(){
        ...
        optional = people.stream()
                        .filter(p -> p.getPersonId() == expected.getPersonId())
                        .findFirst();
    ...
    public void task10(){
        ...
        optional = people.stream()
                        ...
                        .map(p -> p.getDateOfBirth().format(DateTimeFormatter.ofPattern("EEEE d MMMM y")).toUpperCase())
                        .findFirst();
    ...
    public void task11(){
        ...
        double averageAge = people.stream()
                ...
                .reduce(0, (age1, age2) -> age1 + age2) / (double)people.size();
    ...
    public void task13(){
        ...
        people.forEach(person -> {
            personMap.put(person.getLastName(),
                    people.stream()
                            .filter(p -> p.getLastName() == person.getLastName())
                            .collect(Collectors.toList())
            );
        });
    ...
    public void task14(){
        ...
        _2020_dates = Stream.iterate(firstDay,
                date -> date.plusDays(1))
                        .limit(firstDay.isLeapYear() ? 366 : 365)
